          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <div className="pt-4 flex flex-wrap gap-4">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="bg-indigo-600 text-white border-indigo-400 hover:bg-indigo-700"
                >
            ...
            <div className="flex-1 mt-8 md:mt-0">
              <div className="relative w-full h-[300px] md:h-[400px] rounded-lg overflow-hidden shadow-xl">
                <img
                  src="/gradiant-teacher-illustration.png"
                  alt="Gradiant education platform dashboard"
