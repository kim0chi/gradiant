      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">2 classes added this week</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="lg:col-span-3">
              <CardHeader>
                ...
                <CardDescription>Activities and assignments due in the next 7 days</CardDescription>
              </CardHeader>
              <CardContent>
                <UpcomingActivities />
              </CardContent>
