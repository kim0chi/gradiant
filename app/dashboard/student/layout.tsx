        ...
        */}
        ...
        >
          {/* 
            ...
            This ensures the sidebar works for student role
          */}
          <RoleNav
            role="student"
        ...
        >
          {/* 
            Header - Contains mobile menu trigger, user greeting, theme toggle, and user menu
            The sticky top-0 ensures the header stays at the top when scrolling
          */}
          <header className="sticky top-0 z-10 h-16 border-b bg-background flex items-center justify-between px-4">
            <div className="flex items-center gap-2">
              ...
              {/* Personalized greeting for student */}
