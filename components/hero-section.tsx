        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          ...
          <div className="relative">
            <div className="relative mx-auto overflow-hidden rounded-xl border shadow-2xl">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 backdrop-blur-[1px]"></div>
            ...
            <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-400 opacity-80 blur-2xl"></div>
            <div className="absolute -right-6 -top-6 h-24 w-24 rounded-lg bg-gradient-to-br from-blue-400 to-cyan-400 opacity-80 blur-2xl"></div><div className="absolute -right-6 -top-6 h-24 w-24 rounded-lg bg-gradient-to-br from-purple-500 to-blue-500 opacity-80 blur-2xl"></div>
          </div>
        </div>
      </div>
    </section>
